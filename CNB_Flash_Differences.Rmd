...
The mean accuracy on the ADT36 A of the Flash group is statistically **significantly different** from that of the non-Flash group in the AD analysis with an effect size of `r ADT36_AsumAcc$effsizeAD`. On the other hand, the mean accuracy on the ADT36 A of the Flash group is not significantly different from the non-Flash group in the LY analysis. 

```{r, echo=FALSE}
ADT36_AsumAcc$ttestAD
ADT36_AsumAcc$boxAD
```

Flash (n=`r as.numeric(ADT36_AsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(ADT36_AsumAcc$nAD[1,4])`)

Though the means are significantly different, the box plots show that the two groups are not too different from one another.
...
Last year of Flash (n=`r as.numeric(ADT36_AsumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(ADT36_AsumAcc$nAD[1,4])`)



### AIM

The mean accuracy on the AIM of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses.
...
Flash (n=`r as.numeric(AIMsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(AIMsumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(AIMsumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(AIMsumAcc$nAD[1,4])`)


### CPF B

The mean accuracy on the CPF B of the Flash group is statistically **significantly different** from that of the non-Flash group in the AD analysis with an effect size of `r CPF_BsumAcc$effsizeAD`. On the other hand, the mean accuracy on the CPF B of the Flash group is not significantly different from the non-Flash group in the LY analysis.
...
All dates of Flash (n=`r as.numeric(ADT36_AsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(ADT36_AsumAcc$nAD[1,4])`)
...
The mean accuracy on the ER40 D of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses.

```{r, echo=FALSE}
ER40_DsumAcc$ttestAD
ER40_DsumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(ER40_DsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(ER40_DsumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(ER40_DsumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(ER40_DsumAcc$nAD[1,4])`)


### GNG150

The mean accuracy on the GNG150 of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses.

```{r, echo=FALSE}
GNG150sumAcc$ttestAD
GNG150sumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(GNG150sumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(GNG150sumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(GNG150sumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(GNG150sumAcc$nAD[1,4])`)


### KCPW A

The mean accuracy on the KCPW A of the Flash group is statistically **significantly different** from that of the non-Flash group in the AD analysis with an effect size of `r KCPW_AsumAcc$effsizeAD`. On the other hand, the mean accuracy on the KCPW A of the Flash group is not significantly different from the non-Flash group in the LY analysis.

```{r, echo=FALSE}
KCPW_AsumAcc$ttestAD
KCPW_AsumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(KCPW_AsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(KCPW_AsumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(KCPW_AsumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(KCPW_AsumAcc$nAD[1,4])`)


### KSPVRT D

The mean accuracy on the KSPVRT D of the Flash group is not significantly different from that of the non-Flash group in the AD analysis. On the other hand, the mean accuracy on the KSPVRT D of the Flash group is statistically **significantly different** from that of the non-Flash group in the LY analysis with an effect size of `r KSPVRT_DsumAcc$effsizeLY`.

```{r, echo=FALSE}
KSPVRT_DsumAcc$ttestAD
KSPVRT_DsumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(KSPVRT_DsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(KSPVRT_DsumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(KSPVRT_DsumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(KSPVRT_DsumAcc$nAD[1,4])`)
...
The mean accuracy on the MEDF36 A of the Flash group is statistically **significantly different** from that of the non-Flash group in the AD analysis with an effect size of `r MEDF36_AsumAcc$effsizeAD`. On the other hand, the mean accuracy on the MEDF36 A of the Flash group is not significantly different from the non-Flash group in the LY analysis.

```{r, echo=FALSE}
MEDF36_AsumAcc$ttestAD
MEDF36_AsumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(MEDF36_AsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(MEDF36_AsumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(MEDF36_AsumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(MEDF36_AsumAcc$nAD[1,4])`)


### PCET A

The mean accuracy on the PCET A of the Flash group is not significantly different from that of the non-Flash group in the AD analysis. On the other hand, the mean accuracy on the PCET A of the Flash group is statistically **significantly different** from that of the non-Flash group in the LY analysis with an effect size of `r PCET_AsumAcc$effsizeLY`.

```{r, echo=FALSE}
PCET_AsumAcc$ttestAD
PCET_AsumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(PCET_AsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(PCET_AsumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(PCET_AsumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(PCET_AsumAcc$nAD[1,4])`)

The box plots look **different** enough that warrant more testing. One thing to note here is that the non-Flash group consists of `r as.numeric(PCET_AsumAcc$nAD[1,4])` (on the smaller side) participants for both AD and LY.


### PMAT24 A

The mean accuracy on the PMAT24 A of the Flash group is not significantly different from the non-Flash group in both the AD and LY analyses.

```{r, echo=FALSE}
PMAT24_AsumAcc$ttestAD
PMAT24_AsumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(PMAT24_AsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(PMAT24_AsumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(PMAT24_AsumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(PMAT24_AsumAcc$nAD[1,4])`)


### SLNB2 90

The mean accuracy on the SLNB2 90 of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses.

```{r, echo=FALSE}
SLNB2_90sumAcc$ttestAD
SLNB2_90sumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(SLNB2_90sumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(SLNB2_90sumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(SLNB2_90sumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(SLNB2_90sumAcc$nAD[1,4])`)


### SPCPTN90

The mean accuracy on the SPCPTN90 of the Flash group is not significantly different from the non-Flash group in the AD and LY analysis.

```{r, echo=FALSE}
SPCPTN90sumAcc$ttestAD
SPCPTN90sumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(SPCPTN90sumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(SPCPTN90sumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(SPCPTN90sumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(SPCPTN90sumAcc$nAD[1,4])`)


### SPCPTNL

The mean accuracy on the SPCPTNL of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses.

```{r, echo=FALSE}
SPCPTNLsumAcc$ttestAD
SPCPTNLsumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(SPCPTNLsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(SPCPTNLsumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(SPCPTNLsumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(SPCPTNLsumAcc$nAD[1,4])`)


### SVOLT A

The mean accuracy on the SVOLT A of the Flash group is not significantly different from the non-Flash group in both the AD and LY analyses.

```{r, echo=FALSE}
SVOLT_AsumAcc$ttestAD
SVOLT_AsumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(SVOLT_AsumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(SVOLT_AsumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(SVOLT_AsumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(SVOLT_AsumAcc$nAD[1,4])`)


### VSPLOT15

The mean accuracy on the VSPLOT15 of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses.

```{r, echo=FALSE}
VSPLOT15sumAcc$ttestAD
VSPLOT15sumAcc$boxAD
```

All dates of Flash (n=`r as.numeric(VSPLOT15sumAcc$nAD[2,4])`), non-Flash (n=`r as.numeric(VSPLOT15sumAcc$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(VSPLOT15sumAcc$nLY[2,4])`), non-Flash (n=`r as.numeric(VSPLOT15sumAcc$nAD[1,4])`)
...
These are the results from t-tests for each task looking for differences between mean speed in the flash and non-flash groups. Age and sex were regressed out prior to the t-test. There are two results for each task: one comparison uses all available data for both Flash and non-Flash (all dates, AD), and the other compares all non-Flash data with only the last year's worth of available Flash data with all non-Flash data (last year, LY).
...
The mean speed on the ADT36 A of the Flash group is statistically **significantly different** from that of the non-Flash group in the AD analysis with an effect size of `r ADT36_AsumSp$effsizeAD`. On the other hand, the mean speed on the ADT36 A of the Flash group is not significantly different from the non-Flash group in the LY analysis. 

```{r, echo=FALSE}
ADT36_AsumSp$ttestAD
ADT36_AsumSp$boxAD
```

All dates of Flash (n=`r as.numeric(ADT36_AsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(ADT36_AsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(ADT36_AsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(ADT36_AsumSp$nAD[1,4])`)



### AIM

The mean speed on the AIM of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses.
...
All dates of Flash (n=`r as.numeric(AIMsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(AIMsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(AIMsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(AIMsumSp$nAD[1,4])`)


### CPF B

The mean speed on the CPF B of the Flash group is statistically **significantly different** from that of that of the non-Flash group in the AD analysis with an effect size of `r CPF_BsumSp$effsizeAD`. On the other hand, the mean speed on the CPF B of the Flash group is not significantly different from the non-Flash group in the LY analysis. 
...
All dates of Flash (n=`r as.numeric(CPF_BsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(CPF_BsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(CPF_BsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(CPF_BsumSp$nAD[1,4])`)


### ER40 D

The mean speed on the ER40 D of the Flash group is statistically **significantly different** from that of the non-Flash group in the AD analysis with an effect size of `r ER40_DsumSp$effsizeAD`. On the other hand, the mean speed on the ER40 D of the Flash group is not significantly different from the non-Flash group in the LY analysis. 
...
All dates of Flash (n=`r as.numeric(ER40_DsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(ER40_DsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(ER40_DsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(ER40_DsumSp$nAD[1,4])`)


### GNG150

The mean speed on the GNG150 of the Flash group is statistically **significantly different** from that of the non-Flash group in the AD analysis with an effect size of `r GNG150sumSp$effsizeAD`. On the other hand, the mean speed on the GNG150 of the Flash group is not significantly different from the non-Flash group in the LY analysis. 
...
All dates of Flash (n=`r as.numeric(GNG150sumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(GNG150sumSp$nAD[1,4])`)

The box plots show a **difference** between the two groups, big enough to warrant futher investigation.
...
Last year of Flash (n=`r as.numeric(GNG150sumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(GNG150sumSp$nAD[1,4])`)


### KCPW A

The mean speed on the KCPW A of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses.
...
All dates of Flash (n=`r as.numeric(KCPW_AsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(KCPW_AsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(KCPW_AsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(KCPW_AsumSp$nAD[1,4])`)


### KSPVRT D

The mean speed on the KSPVRT D of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses.

```{r, echo=FALSE}
KSPVRT_DsumSp$ttestAD
KSPVRT_DsumSp$boxAD
```

All dates of Flash (n=`r as.numeric(KSPVRT_DsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(KSPVRT_DsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(KSPVRT_DsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(KSPVRT_DsumSp$nAD[1,4])`)


### MEDF36 A

The mean speed on the MEDF36 A of the Flash group is not significantly different from that of the non-Flash group in the AD and LY analysis.

```{r, echo=FALSE}
MEDF36_AsumSp$ttestAD
MEDF36_AsumSp$boxAD
```

All dates of Flash (n=`r as.numeric(MEDF36_AsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(MEDF36_AsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(MEDF36_AsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(MEDF36_AsumSp$nAD[1,4])`)


### MPRACT

The mean speed on the MPRACT of the Flash group is not significantly different from that of the non-Flash group in the AD and LY analysis. 
...
All dates of Flash (n=`r as.numeric(MPRACTsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(MPRACTsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(MPRACTsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(MPRACTsumSp$nAD[1,4])`)


### PCET A

The mean speed on the PCET A of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses. 
...
All dates of Flash (n=`r as.numeric(PCET_AsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(PCET_AsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(PCET_AsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(PCET_AsumSp$nAD[1,4])`)


### PMAT24 A

The mean speed on the PMAT24 A of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses. 

```{r, echo=FALSE}
PMAT24_AsumSp$ttestAD
PMAT24_AsumSp$boxAD
```

All dates of Flash (n=`r as.numeric(PMAT24_AsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(PMAT24_AsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(PMAT24_AsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(PMAT24_AsumSp$nAD[1,4])`)


### SCTAP

The mean speed on the SCTAP of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses. 
...
The mean speed on the SLNB2 90 of the Flash group is statistically **significantly different** from that of the non-Flash group in the AD analysis with an effect size of `r SLNB2_90sumSp$effsizeAD`. On the other hand, the mean speed on the SLNB2 90 of the Flash group is not significantly different from the non-Flash group in the LY analysis. 

```{r, echo=FALSE}
SLNB2_90sumSp$ttestAD
SLNB2_90sumSp$boxAD
```

All dates of Flash (n=`r as.numeric(SLNB2_90sumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(SLNB2_90sumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(SLNB2_90sumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(SLNB2_90sumSp$nAD[1,4])`)


### SPCPTN90

The mean speed on the SPCPTN90 of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses. 

```{r, echo=FALSE}
SPCPTN90sumSp$ttestAD
SPCPTN90sumSp$boxAD
```
...
The mean speed on the SPCPTNL of the Flash group is statistically **significantly different** from that of the non-Flash group in the AD analysis with an effect size of `r SPCPTNLsumSp$effsizeAD`. On the other hand, the mean speed on the SPCPTNL of the Flash group is not significantly different from the non-Flash group in the LY analysis. 

```{r, echo=FALSE}
SPCPTNLsumSp$ttestAD
SPCPTNLsumSp$boxAD
```

All dates of Flash (n=`r as.numeric(SPCPTNLsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(SPCPTNLsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(SPCPTNLsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(SPCPTNLsumSp$nAD[1,4])`)


### SVOLT A

The mean speed on the SVOLT A of the Flash group is not significantly different from that of the non-Flash group in both the AD and LY analyses. 

```{r, echo=FALSE}
SVOLT_AsumSp$ttestAD
SVOLT_AsumSp$boxAD
```

All dates of Flash (n=`r as.numeric(SVOLT_AsumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(SVOLT_AsumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(SVOLT_AsumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(SVOLT_AsumSp$nAD[1,4])`)


### VSPLOT15

The mean speed on the VSPLOT15 of the Flash group is statistically **significantly different** from that of the non-Flash group in the AD analysis with an effect size of `r VSPLOT15sumSp$effsizeAD`. On the other hand, the mean speed on the VSPLOT15 of the Flash group is not significantly different from the non-Flash group in the LY analysis. 

```{r, echo=FALSE}
VSPLOT15sumSp$ttestAD
VSPLOT15sumSp$boxAD
```

All dates of Flash (n=`r as.numeric(VSPLOT15sumSp$nAD[2,4])`), non-Flash (n=`r as.numeric(VSPLOT15sumSp$nAD[1,4])`)
...
Last year of Flash (n=`r as.numeric(VSPLOT15sumSp$nLY[2,4])`), non-Flash (n=`r as.numeric(VSPLOT15sumSp$nAD[1,4])`)
...
The participants' Flash scores correlate fairly ok with their non-Flash scores, and the correlation coefficient matches up pretty well with the ICC. 
...
The participants' Flash scores correlate well with their non-Flash scores, and the correlation coefficient matches up pretty well with the ICC. 
...
The participants' Flash scores correlate fairly ok with their non-Flash scores, and the correlation coefficient matches up well with the ICC. 
...
The participants' Flash scores correlate **very poorly** with their non-Flash scores, and the correlation coefficient matches up well with the ICC. 
...
The participants' Flash scores correlate decently with their non-Flash scores, and the correlation coefficient matches up well with the ICC. 
...
The participants' Flash scores correlate fairly well with their non-Flash scores, and the correlation coefficient matches up well with the ICC. 
...
The participants' Flash scores correlate very well with their non-Flash scores, and the correlation coefficient matches up well with the ICC. 
...
The participants' Flash scores correlate **poorly** with their non-Flash scores, and the correlation coefficient matches up well with the ICC. 
...
The participants' Flash scores correlate well with their non-Flash scores, and the correlation coefficient matches up well with the ICC. 
...
The participants' Flash scores correlate very well with their non-Flash scores, and the correlation coefficient does **not** match up with the ICC as well as it has in other tasks. This suggests that there is a difference in level/scale across Flash and non-Flash speeds.
